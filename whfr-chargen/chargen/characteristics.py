...
FULL_NAME_PL = {
        ...
        'mag': 'Magia',
        'ip': 'Punkty Obłędu',
        'fp': 'Punkty Przeznaczenia',
        }

FIRST_ROW = """ws bs s t ag int wp fel""".split()
SECOND_ROW = """a w sb tb m mag ip fp""".split()
...
def pretty_table(chars):
    ...
    data  = [ list(map(str.upper, FIRST_ROW)),  [chars[i] for i in FIRST_ROW] ]
    data2 = [ list(map(str.upper, SECOND_ROW)), [chars[i] for i in SECOND_ROW] ]
